...
export const FLOATING_IMAGES: FloatingImageConfig[] = [
  ...
  { src: "/work/norlanka.webp",     alt: "Norlanka project (variant)",  speed: 9.5,  phase: 3.0, amplitude: 13 },
  { src: "/work/advantis.webp",     alt: "Advantis project (variant)",  speed: 8.5,  phase: 2.0, amplitude: 15 },
  { src: "/work/ginger-fresh.webp", alt: "Ginger Fresh project (variant)", speed: 10.5, phase: 0.5, amplitude: 17 },

  { src: "/work/softlogic.webp",    alt: "Softlogic project (variant)", speed: 9,    phase: 3.6, amplitude: 15 },
  { src: "/work/fairfirst.webp",    alt: "Fairfirst Insurance project (variant)", speed: 10.5, phase: 0.2, amplitude: 12 },
  { src: "/work/norlanka.webp",     alt: "Norlanka project (variant 2)", speed: 8.2,  phase: 2.2, amplitude: 11 },
  { src: "/work/advantis.webp",     alt: "Advantis project (variant 2)", speed: 9.7,  phase: 1.1, amplitude: 14 },
];
